...
class HangmanGame(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.charInput.setValidator(QRegExpValidator(QRegExp("[a-z]+"), self)) # 영어만 입력
    ...
    def startGame(self):
        ...
        self.guess = Guess(self.word.randFromDB(7))
    ...
    def guessClicked(self):
        ...
        if self.guess.finished():
            ...
            self.message.setText('Fail! Word is ' + self.guess.secretWord)
            self.charInput.setReadOnly(True)
            self.guessButton.setDisabled(True)
